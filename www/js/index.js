...
function generateResult(result) {
    ...
    if(result.hasOwnProperty("face")) {
        ...
        "   <img id='detect-face' class='img-fluid' src='" + loadingImg + "' style='display:none;max-height: 120px'>" +
        "</div><br>" +
        "<div class='d-flex justify-content-center justify-content-between'>" +
        "   <button id='check-ls' onClick='startLiveness()' class='btn btn-danger btn-sm' style='display:none;' >" +
        "       <div class='d-flex justify-content-center'>" +
        "           <img style='height:22px' src='./img/ic_liveness.png' class='img-fluid'>" +
        "           <h5>Liveness</h5>" +
        "       </div>" +
        "   </button>" +
        "   <button id='check-fm' onClick='startFaceMatch()' class='btn btn-danger btn-sm' style='display:none;'>" +
        "       <div class='d-flex justify-content-center'>" +
        "           <img style='height:22px' src='./img/ic_biometric.png' class='img-fluid'>" +
        "           <h5>Face Match</h5>" +
        "       </div>" +
        "   </button>" +
        "</div>" +
        "<div id='score-div' style='display:none;' class='d-flex justify-content-center justify-content-between'>" +
                ...
                if(i === 0) {                    
                    switch(result.type) {
                        case "MRZ":
                            ...
                            break;
                        case "OCR":
                            html += "<h4 class='font-weight-bold p-2' style='background:lightgrey;'>OCR Front</h4>";
                            break;
                        case "DL_PLATE":
                            html += "<h4 class='font-weight-bold p-2' style='background:lightgrey;'>Vehicle Plate</h4>";
                            break;
                        case "BARCODE":
                            html += "<h4 class='font-weight-bold p-2' style='background:lightgrey;'>Barcode</h4>";
                            break;
                        case "PDF417":
                            html += "<h4 class='font-weight-bold p-2' style='background:lightgrey;'>PDF417 Barcode</h4>";
                            break;
                        case "BARCODEPDF417":
                            html += "<h4 class='font-weight-bold p-2' style='background:lightgrey;'>BARCODE PDF417</h4>";
                            break;
                        case "BANKCARD":
                            html += "<h4 class='font-weight-bold p-2' style='background:lightgrey;'>Bank Card</h4>";
                            break;
                        default:
                            html += "<h4 class='font-weight-bold p-2' style='background:lightgrey;'>Front Side</h4>";
                            break;
                    }
                } else {
                    html += "<h4 class='font-weight-bold p-2' style='background:lightgrey;'>OCR Back</h4>";
                }
                    ...
                    if(key !== "PDF417") {
                        if(["signature", "front_img", "back_img"].toString().indexOf(key) === -1) {
                            if(result[side][key] !== null && result[side][key] !== undefined && result[side][key].toString().includes("<")) {
                                table += "<tr><td class='text-danger p-2'>" + key + "</td><td style='white-space: pre-wrap;word-break: break-word;'>" + result[side][key].toString().replace(/</g, '&lt') + "</td></tr>";
                            } else {
                                if(result.type == "MRZ") {
                                    table += "<tr><td class='text-danger p-2'>" + key + "</td><td style='white-space: pre-wrap;word-break: break-word;'>" + result[side][key] + "</td></tr>";
                                } else {
                                    table += "<tr><td class='text-danger p-2'>" + key + "</td><td style='white-space: pre-wrap;word-break: break-word;'>" + result[side][key] + "</td></tr>";
                                }
                            }
...
//                    table += "<tr><td><h4 class='font-weight-bold p-2' style='background:lightgrey;'>PDF417 Barcode</h4></td></tr>";
//                    html += "<h4 class='font-weight-bold p-2' style='background:lightgrey;'>PDF417 Barcode</h4>";
        ...
        if(keys.length > 0) {
            ...
            if (result.mrz_data.hasOwnProperty("MRZ")) {
                if(result.mrz_data.MRZ.toString().indexOf("<") !== -1) {
                    table += "<tr><td class='text-danger p-2'>MRZ</td><td style='white-space: pre-wrap;word-break: break-word;'>" + result.mrz_data.MRZ.toString().replace(/</g, '&lt') + "</td></tr>";
                } else {
                    table += "<tr><td class='text-danger p-2'>MRZ</td><td style='white-space: pre-wrap;word-break: break-word;'>" + result.mrz_data.MRZ + "</td></tr>";
                }
            }

            keys.forEach(function(key) {
                if (key !== "MRZ") {
                    if(result.mrz_data[key].toString().includes("<") !== -1) {
                        table += "<tr><td class='text-danger p-2'>" + key + "</td><td style='white-space: pre-wrap;word-break: break-word;'>" + result.mrz_data[key].toString().replace(/</g, '&lt') + "</td></tr>";
                    } else {
                        table += "<tr><td class='text-danger p-2'>" + key + "</td><td style='white-space: pre-wrap;word-break: break-word;'>" + result.mrz_data[key] + "</td></tr>";
                    }
                }
            })
